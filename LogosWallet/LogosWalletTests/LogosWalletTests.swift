...
class LogosWalletTests: XCTestCase {
    ...
    func testImportSeed() {
        // Given
        let expectedAddress = "lgs_38ncappfy6i6mmz5kx93e6rh88tnx9ne68g644u88u9wjqwr3ua5jdrhqgxm"
        ...
        XCTAssert(expectedAddress == keyPair?.lgsAccount)
    }
    
    func testImportSeedNAccounts() {
        let addresses = [
            "lgs_38ncappfy6i6mmz5kx93e6rh88tnx9ne68g644u88u9wjqwr3ua5jdrhqgxm",
            "lgs_36p4xfxn365i9h7oxta6tdmu53zndrm45r3x9ag9naa3mxnnpn3p6tjfqzqm",
            "lgs_34ni44uj4xuy54nyhrbgjqsmi1yogpzqsgiiwz4a4huuzojz8g6a6tr1mu1m",
            "lgs_1dfsmb9gkaphtt7dyxu9idt3djxkdtnq6d6i4dqtk7irnjw39opkjamcp31t",
            "lgs_3ipekn3txsti19orp8mmo68uxet86bdc9y1to5pxnkdbt1tqot7jqes9i46p",
            "lgs_1faux9q4nsu63pma3htoix8rduajaradd5c6zhimoydcmya3pjipnmanzkee",
            "lgs_3ggswcjqrc8rqm8rr88gut9381p6iggs6pjw4g1gk4wtw7ak73ye4oiu8cik",
            "lgs_1rhff3zskquu4isx6456twxzai71y3tnekcayrk7b3uiyqg6hayzp5ybrbqd",
            "lgs_3f1r95waikrxqh75cedjtnah9k3hbbd5ykz4y8f77z1cbs1ywk1oysq6j8mx",
            "lgs_37bgk64u3ae98r989wyyo9kna3jtfc8teiw3acimjet9j38f4oid891gsxo3",
            "lgs_3y9andg1c7mdxu6fpgumzjdmk431q1jh3igdetwey4zc65p8byw3ggajgw9h",
            "lgs_1axc4durr9xhr5n65csr6n8foyzptr74eoe1613a4a7c5kru8b164h1qeumg",
            "lgs_35qcuzqsgwdph8dp1zjyrdzibtgj4pwu447sge9aior86d8apxjphmcescro",
            "lgs_3wu9npstir1upq8wzf9betxti9b1fxjr6mpko7e7dont7ksgic37a1iezng3",
            "lgs_1e1pmsftjj8h3uq98sjodk8ifsbmhyxy9psnio81d93x5e31f7srdfxx1oxj",
            "lgs_3hihqmudqfwm866r94ygn9nkrzo9ireof6bf4ukchd3jdwg91xeyrnpttbx1",
            "lgs_15w8aksuhbnb14q6r66x6hparoffpojbz1mz3id6kghtykcms95m8senuzpp"
        ]
        let seed = "3E8ABFC17DC5DE84B18935BB40FEB67FB409724B902E028736120AED3092DAEF"
        
        addresses.enumerated().forEach { (index, address) in
            let keyPair = WalletUtil.keyPair(seed: seed.hexData!, index: UInt32(index))
            XCTAssert(keyPair?.lgsAccount == address, "Expected \(address), got \(keyPair?.lgsAccount ?? "")")
        }
    }
    ...
    func testPublicKeyToAccount() {
        ...
        // When
        let account = try? WalletUtil.deriveLGSAccount(from: publicKey.hexData!)
        
        // Then
        XCTAssert(account == "lgs_1zxqsfatbn91ijpxogb3iub5dujnaa51xqmi84xy1qci4wyjunp45y6abnw3")
    }
