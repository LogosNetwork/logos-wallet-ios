...
class DisclaimerViewController: TransparentNavViewController {
    ...
    fileprivate func buildView() {
        ...
        let disclaimer = "The software you are about to use, \"Logos Wallet\", is free and open source. The software does not constitute an account where Promethean Labs serves as financial intermediaries or custodians of your Logos. While the software has undergone beta testing and continues to be improved by feedback from the community, we, Promethean Labs, cannot guarantee that the software is bug free. You acknowledge that your use of this software is at your own risk and in compliance with all applicable laws. You are responsible for safekeeping your passwords, seeds, private keys, and any other codes (wallet related data) you use to access the software. Promethean Labs cannot retrieve any wallet related data if you lose or forget them."
